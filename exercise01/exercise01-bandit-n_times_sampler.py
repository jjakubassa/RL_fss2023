...
# idea: continuously sample arms (2 times each) and then progressively eliminate actions with lowest expected return
n = 1 # how often should each arm be sampled between each elimination
